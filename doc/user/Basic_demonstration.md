...
## Run the test script
Follow the steps described in the [preparation](prepare.md) section of this documentation to provide the needed python environment for the evaluation. Open a terminal and go to the location of the script.
